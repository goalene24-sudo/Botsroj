...
# --- (تم التعديل) الطريقة الجديدة لبناء النص لضمان التنسيق ---
help_lines = [
...
# بناء النص النهائي مع جعل كل سطر بالخط العريض
CLEANING_COMMANDS_TEXT = "\n".join([f"**{line}**" if line else "" for line in help_lines])
