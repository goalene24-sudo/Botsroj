...
# --- استخدام روابط صور ثابتة ---
LOGO_STYLES = {
    "نار": {
        "bg_url": "https://i.imgur.com/791Dx4g.jpg",
        "font_url": "https://telegra.ph/file/a8041cacc293b6e89f38c.ttf",
        "color": "#FFC300",
        "stroke_color": "#C70039",
        "stroke_width": 4,
        "size": 180
    ...
    "فخم": {
        "bg_url": "https://i.imgur.com/bGDYSPp.jpg",
        "font_url": "https://telegra.ph/file/c822e4c2b9f65a443a296.ttf",
        "color": "#E7C581",
        "stroke_color": "#1C1C1C",
        "stroke_width": 2,
        "size": 220
    ...
    "كرتون": {
        "bg_url": "https://i.imgur.com/yv4yksP.jpg",
        "font_url": "https://telegra.ph/file/a534fe247c7c1a84f4a3e.ttf",
        "color": "#FFFFFF",
        "stroke_color": "#000000",
        "stroke_width": 5,
        "size": 200
    ...
    "default": {
        "bg_url": "https://i.imgur.com/JCRD6Oa.jpg",
        "font_url": "https://telegra.ph/file/c3c2f2162a5b672a9121a.ttf",
        "color": "white",
        "stroke_color": "black",
        "stroke_width": 3,
        "size": 220
...
async def logo_creator(event):
    ...
    try:
        ...
        try:
            # طريقة أحدث لحساب أبعاد النص
            text_bbox = draw.textbbox((0, 0), text, font=font)
            text_width = text_bbox[2] - text_bbox[0]
            text_height = text_bbox[3] - text_bbox[1]
        except AttributeError:
            # طريقة قديمة كبديل في حال عدم توفر textbbox
